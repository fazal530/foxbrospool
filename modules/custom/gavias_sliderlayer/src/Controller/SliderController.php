...
class SliderController extends ControllerBase {
  ...
  public function gavias_sl_sliders_edit($gid=0, $sid=0) {
   ...
   $style_fontend = $theme_path . '/css/sliderlayer.css';
   if (!file_exists(DRUPAL_ROOT . '/' . $style_fontend)) {
     $style_fontend = \Drupal::service('extension.list.theme')->getPath('gavias_linoor') . '/css/sliderlayer.css';
   }
  ...
  public function gavias_upload_file(){
    ...
    $upload_uri = $file_default_scheme . "://gva-slider-upload";
