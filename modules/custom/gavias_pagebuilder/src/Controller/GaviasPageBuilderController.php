...
class GaviasPageBuilderController extends ControllerBase {
  ...
  public function gavias_pagebuilder_edit($bid) {
    ...
    $module_path = \Drupal::service('extension.list.module')->getPath('gavias_pagebuilder');
    $page['#attached']['drupalSettings']['gavias_pagebuilder']['path_modules'] = base_path() . $module_path;
    ...
    include $module_path . '/templates/backend/form.php';
